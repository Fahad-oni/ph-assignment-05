...
const Footer = () => {
  return (
    <div className="px-4 md:px-12 container mx-auto mt-25">
      <div className="md:grid md:grid-cols-4 gap-8">
        ...
        <div className="space-y-1 hidden md:flex md:flex-col">
          ...
          <a href="#home" className="text-[0.7rem] font-semibold text-[#64748B]">
            Home
          </a>
          <a href="#technologies" className="text-[0.7rem] font-semibold text-[#64748B]">
            Technologies
          </a>
          <a href="#projects" className="text-[0.7rem] font-semibold text-[#64748B]">
            Projects
          </a>
        </div>
        <div className="space-y-1 hidden md:flex md:flex-col">
          <h2 className="text-md font-semibold mb-3">COMPANY</h2>
          <a href="#about" className="text-[0.7rem] font-semibold text-[#64748B]">
            About
          </a>
          <a href="#contact" className="text-[0.7rem] font-semibold text-[#64748B]">
            Contact
          </a>
          <a href="#careers" className="text-[0.7rem] font-semibold text-[#64748B]">
            Careers
          </a>
        </div>
        <div className="space-y-1 hidden md:flex md:flex-col">
          <h2 className="text-md font-semibold mb-3">LEGAL</h2>
          <a href="#privacy" className="text-[0.7rem] font-semibold text-[#64748B]">
            Privacy Policy
          </a>
          <a href="#terms" className="text-[0.7rem] font-semibold text-[#64748B]">
            Terms of Service
          </a>
        </div>
      </div>
